...
const SAVE_CONTAINER_SCENE_PATH = "res://scr/ui/component/save_container/save_container.tscn"
const SAVE_CONTAINER_SCENE = preload(SAVE_CONTAINER_SCENE_PATH)
const SaveContainer = preload("res://scr/ui/component/save_container/save_container.gd")
